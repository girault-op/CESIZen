...
return [
    ...
    */
    ...
    | allow you to control the amount of time it takes to hash the
    | given password. You may adjust these as needed.
    |
    */
    ...
    | allow you to control the amount of time it takes to hash the
    | given password as well as the memory and threads used.
    |
    */
